...
@ManagedBean(name="testProfileManager")
@SessionScoped
public class TestProfileManager extends BasicDataTable {
	...
	@PostConstruct
	public void init() {
		headerRows = new String[] {"Hilly", "Billy", "Wakudoki"};
		dataArr = new Object[21][];
		for (int i=0;i<21;i++) {
			dataArr[i] = new Object[] {"test"+i, "test"+i, UUID.randomUUID().toString()};
		}
	}
